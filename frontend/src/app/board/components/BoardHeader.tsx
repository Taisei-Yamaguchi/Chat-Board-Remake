...
import LogoutButton from "@/app/home/components/LogoutButton";
...
const BoardHeader:FC<Props> = ({boardTitle}) => {
	...
	return (
		<header className="bg-gradient-to-r from-gray-400 to-white fixed pt-2 top-0 left-0 right-0 z-10 h-14 flex w-full items-center justify-between p-2">
			{/* left menu */}
