...
from .views import BoardCreate,BoardGet,BoardSearch,BoardHide,CommentCreate,CommentHide,ImageCreate
...
urlpatterns = [
    ...
    path('comment-image/create/<int:board_id>', ImageCreate.as_view(), name='comment-image-create'),  
